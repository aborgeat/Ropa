    		...
    		<div class="row">  
				<div class="col-xs-12 col-sm-12 col-md-12 padding-right"> 
					<div class="col-xs-4 col-sm-4">
						<div id="main-contact-form" class="contact-form row">													
							<div class="form-group col-md-12 col-sm-12">
								<form:form action="/ropa/altaCat" modelAttribute="categoria" role="form" method="POST" name="altaCat" >
					...
					<div class="col-xs-4 col-sm-4">
						<div id="main-contact-form" class="contact-form row">													
							<div class="form-group col-md-12 col-sm-12">
								<form:form action="/ropa/altaCol" modelAttribute="color categoria" role="form" method="POST" name="altaCol" >
								  <div class="form-group">
									<input type="text" name="color" class="form-control" placeholder="Nuevo Color" required="required" 
									pattern="[A-Za-z ñáéíóú]{2,15}" title="Ej: Color"/>
								<button type="submit"  class="btn btn-primary pull-right" id="boton">Ingresar</button>
								  </div>
								</form:form>
							</div>
							...
							<div class="form-group col-md-12 col-sm-12">
								 <div id="contact-page" class="table-responsive">
									...
									<thead>
										...
										<tbody>	
										<c:forEach items="${serviciocolor}" var="color">
											<tr>
												<td>
													${color.color}
					...
					<div class="col-xs-4 col-sm-4">
						<form  id="main-contact-form" class="contact-form row" name="talle">													
							<div class="form-group col-md-12 col-sm-12">
								<form:form action="/ropa/altaTal" modelAttribute="producto" role="form" method="POST" name="altaTal" >
								  <div class="form-group">
									<input type="text" name="cat" class="form-control" placeholder="Nuevo Talle" required="required" 
									pattern="[a-zA-Z0-9 ñáéíóú]{2,15}" title="Ej: XL ó 38"/>
								<button type="submit"  class="btn btn-primary pull-right" id="boton">Ingresar</button>
								  </div>
								</form:form>
							</div>
							<div class="form-group col-md-12 col-sm-12">
								<a href="/ropa/bajaOmodifPro"><input type="button" name="bajaTal" class="btn btn-primary pull-left col-xs-12 col-md-12 col-sm-12" value="Baja / Modificación"/></a>
							</div>	
							<div class="form-group col-md-12 col-sm-12">
								<a href="/ropa/verProductos"><input type="button" name="listaTal" class="btn btn-primary pull-left col-xs-12 col-md-12 col-sm-12" value="Listado"/></a>
							</div>							
						</form>
					</div>  
				</div>
